...
public class Report implements Comparable<Report>{
    ...
    public Report(int id, String repname, int status, Date startDate, Date endDate, String repProg, String hash, String comment) {
        this.id = id;
    ...
    public int compareTo(Report o) {
        return this.repname.compareTo(o.repname);
    }
}
